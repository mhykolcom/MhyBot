...
const twitchApi = require('util/twitch');
const {discordtoken} = require('./config/config.json');
const db = require('util/mongo').connect();
...
function getChannelInfo(server, err, res) {
    ...
    res.users.forEach((user) => {
        ...
        twitchApi.streams.channel({channelID: user._id}, postDiscord.bind(this, server, twitchChannelInfo));
    })
}
